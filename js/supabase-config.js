...
window.SUPABASE_CONFIG = {
  url: "https://wrihvbryodnyxxotbnol.supabase.co",           // ej: https://xxxxxxxx.supabase.co
  anonKey: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6IndyaWh2YnJ5b2RueXh4b3Ribm9sIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODUyNjM1MDEsImV4cCI6MjEwMDgzOTUwMX0.CYaPu0_KT8-_MrsB6cpOe2mnQOY3EbrFtZzFCj5ocQo",  // clave pública (anon / publishable)
...
window.supabaseClient = (function () {
  ...
  if (!window.SUPABASE_READY) {
    console.warn(
      "[Sneakers Jhon] Supabase no está configurado todavía. " +
